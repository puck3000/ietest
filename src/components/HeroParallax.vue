...
<div class="parallax">
    <div class="parallaxWrapper" v-cloak>
        ...
        >
<!-- 
        <img class="paral" v-parallax.absY="0.5" src="@/assets/Parallaxium/SCHAFE-ZIEGEN_Parallax_C_1300.png"></img>
        <img class="paral" v-parallax.absY="0.25" src="@/assets/Parallaxium/SCHAFE-ZIEGEN_Parallax_B_1300.png"></img>
        <img class="paral last" v-parallax.absY="0" src="@/assets/Parallaxium/SCHAFE-ZIEGEN_Parallax_A_1300.png"></img> -->
